/*
!! USES your username and password, best use the token !!
...
bool GithubApi::retrieveData(const std::string &url, const std::string &username, const std::string &password, std::string &response)
{
    if (!curl_)
    {
        return false;
